...
import 'package:tinder/HomePage.dart';
...
class PhoneNumberScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new Padding(
        padding: EdgeInsets.only(left: ScreenUtil().setWidth(50.0), right: ScreenUtil().setWidth(50.0)),
        child: new Column(
          children: <Widget>[
            new Expanded(
                flex: 5,
                  ...
                  children: <Widget>[
                    new Align(
                      ...
                      child: new Text(
                        "My number is",
                        style: new TextStyle(
                            fontSize: ScreenUtil().setSp(100.0), fontWeight: FontWeight.w600, color: Colors.black54),
                      ),
                    ),
                    new SizedBox(
                    ...
                    new Text(
                      ...
                      style: new TextStyle(
                          fontSize: ScreenUtil().setSp(37.0), fontWeight: FontWeight.w500, color: Colors.black54),
                    ),
                    new SizedBox(
